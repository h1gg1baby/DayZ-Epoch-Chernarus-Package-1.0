...
class_customLoadout = [
	"76561198067477778", // Lenny
	"0",
	"0"
];
class_customLoadouts = [ // These are only visible to their owner
	["Lenny's Loadout","Bandit1_DZ","BanditW1_DZ",["100Rnd_762x51_M240",2,"15Rnd_9x19_M9SD",3,"Skin_Sniper1_DZ",VIP_ITEMS],["Mk48_CCO_DZ","M9_SD_DZ",VIP_TOOLS],"DZ_Backpack_EP1",["20Rnd_762x51_DMR",3],["DMR_DZ"],0,"MeleeHatchet"],
	[],
	[]
];
...
spawn_bases = [
	["Lenny's base",[4290.5732, 10949.117,0]],
	[],
	[]
];
