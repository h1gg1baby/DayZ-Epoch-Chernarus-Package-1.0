...
ai_moneyMultiplier	 = 400; //This value is multiplied by 50 to set the max amount of ZSC coins in AI wallets. ex. 200x50=10000 max coins.
...
ai_remove_humanity	 = 25; // amount of humanity lost for killing a hero AI
