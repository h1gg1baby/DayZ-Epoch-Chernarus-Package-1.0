...
local _missionFiles = ["configVariables.sqf","description.ext","init.sqf","mission.sqm","rules.sqf","dayz_code\DZAI_Client\dzai_client_config.sqf","dayz_code\DZAI_Client\dzai_initclient.sqf","dayz_code\init\compiles.sqf","dayz_code\init\variables.sqf","map\balota.sqf","map\basebor.sqf","map\basedichina.sqf","map\basenovy.sqf","map\berezinoharbor.sqf","map\checkpoints.sqf","map\CoastalTunnel.sqf","map\dk_Skalisty.sqf","map\fobwest.sqf","map\Hilltop.sqf","map\hos_gorka.sqf","map\hos_novy.sqf","map\hos_nwa.sqf","map\hos_zeleno.sqf","map\junkyard.sqf","map\kamenka.sqf","map\klamenkamillbase.sqf","map\krasno.sqf","map\NEAFS4M.sqf","map\noa.sqf","map\nwa.sqf","map\nwafPlayground.sqf","map\skalka.sqf","map\solindustry.sqf","map\sp1_nwa.sqf","map\sp2_stary.sqf","map\sp3_elektro.sqf","map\sp4_beri.sqf","map\sp5_zeleno.sqf","map\svetlojarsk.sqf","map\vybor.sqf","map\neu\berezino.sqf","map\neu\klen_2.sqf","map\neu\lopatino.sqf","map\neu\lopatino_2.sqf","map\neu\mil_northairfield.sqf","map\neu\prison.sqf","map\neu\sector_c.sqf","map\neu\tikaya.sqf","map\neu\UN.sqf","map\neu\wtf_base.sqf","spawn\config.sqf","spawn\init.sqf","spawn\main.sqf","spawn\functions\class_fillItems.sqf","spawn\functions\class_fillList.sqf","spawn\functions\class_pick.sqf","spawn\functions\class_preview.sqf","spawn\functions\class_randomMags.sqf","spawn\functions\class_randomTools.sqf","spawn\functions\class_wipeGear.sqf","spawn\functions\cleanup.sqf","spawn\functions\finish.sqf","spawn\functions\spawn_fill.sqf","spawn\functions\spawn_map.sqf","spawn\functions\spawn_pick.sqf"];
